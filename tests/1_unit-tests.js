...
suite('Unit Tests', () => {
    suite('Translate to British English', () => {
        ...
        test('Translate I ate yogurt for breakfast. to British English. to British English', done => {
            assert.equal(translator.toBritishEnglish('I ate yogurt for breakfast.')[0],
        'I ate yoghurt for breakfast.')
        done();
        })
        test('Translate We had a party at my friends condo. to British English', done => {
    ...
    suite('Translate to American English', () => {
        ...
        test('Translate Prof Joyner of Kings College, London. to American English', done => {
            assert.equal(translator.toAmericanEnglish('Prof Joyner of Kings College, London.')[0],
        'Prof. Joyner of Kings College, London.')
        done();
        })
